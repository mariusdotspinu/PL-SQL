...
public class SelectWithIndex {
    ...
    public SelectWithIndex(ToggleGroup group,Stage primaryStage,TableView tableView){
        ...
        select.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try{
                    ...
                    tableV = sqlOperations.selectIndexNoLike(r1.getText(),input.getText(),value.getText());
                } catch (SQLException e) {
                    e.printStackTrace();
                }
